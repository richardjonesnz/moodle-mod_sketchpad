...
/**
 * The main sketchpad configuration form
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_sketchpad_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('sketchpadname', 'sketchpad'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'sketchpadname', 'sketchpad');

        // Adding the standard "intro" and "introformat" fields.
        $this->standard_intro_elements();

        // Add a specific mod_sketchpad field - title.
